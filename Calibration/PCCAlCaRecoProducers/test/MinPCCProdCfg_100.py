...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/eos/cms/store/data/Run2015D/AlCaLumiPixels/ALCARECO/LumiPixels-PromptReco-v3/000/256/495/00000/4EA15ABF-255D-E511-9D1E-02163E0119C7.root')
)
...
process.alcaPCCProducer = cms.EDProducer("AlcaPCCProducer",
    AlcaPCCProducerParameters = cms.PSet(
        ...
        countEveryNLumi = cms.untracked.int32(100),
...
process.ALCARECOStreamPromptCalibProdPCC = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PromptCalibProdPCC_100.root'),
    outputCommands = cms.untracked.vstring('drop *', 
        'keep *_alcaPCCProducer_*_*', 
        'keep *_MEtoEDMConvertSiStrip_*_*')
)
